...
![Untitled](../upload/ECE313.png){: .w-50}
...
![Untitled](../upload/ECE313-1.png){: .w-50}
...
![Likelihood matrix](../upload/ECE313-2.png)
...
![Decision rule](../upload/ECE313-3.png)
...
![ML decision rule](../upload/ECE313-4.png)
...
![joint probability matrix $\pi_0 = 0.8, \pi_1 = 0.2$ ](../upload/ECE313-5.png){: .w-50}
...
![Untitled](../upload/ECE313-6.png){: .w-50}
...
![Different distribution in one graph](../upload/ECE313-7.png){: .w-75}
...
![Alt text](/img/post/ECE313-3.png)
