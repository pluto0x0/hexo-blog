...
![Untitled](/img/post/ECE313.png){: .w-50}
...
![Untitled](/img/post/ECE313-1.png){: .w-50}
...
![joint probability matrix $\pi_0 = 0.8, \pi_1 = 0.2$ ](/img/post/ECE313-5.png){: .w-50}
...
![Untitled](/img/post/ECE313-6.png){: .w-50}
...
![Different distribution in one graph](/img/post/ECE313-7.png){: .w-75}
